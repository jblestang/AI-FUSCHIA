...
#[cfg_attr(any(test, feature = "testutils", feature = "benchmark"), derivative(PartialEq(bound = "M: PartialEq"), Eq))]
...
#[derive(Debug, Derivative)]
#[cfg_attr(any(test, feature = "testutils", feature = "benchmark"), derivative(Clone, PartialEq, Eq))]
...
#[cfg_attr(any(test, feature = "testutils", feature = "benchmark"), derivative(PartialEq, Eq))]
